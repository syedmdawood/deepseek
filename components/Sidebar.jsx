...
const Sidebar = ({ expand, setExpand }) => {
  ...
  const { user, createNewChat, chats } = useAppContext();
      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-500 h-9 w-9 aspect-square  rounded-lg cursor-pointer"
          >
            ...
            <div
              ...
              } opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-3 rounded-lg shadow-lg pointer-events-none`}
            >
